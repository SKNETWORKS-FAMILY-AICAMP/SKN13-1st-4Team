...
- **박현아**:  
  웹크롤링부터 streamlit 구현까지 모두 해볼 수 있는 기회였습니다. 생각보다 시간이 촉박했지만, 팀원들의 도움으로 무사히 끝낼 수 있었다고 생각합니다! 다들 너무 감사했습니당~
...
- **우민규**:  
  DB의 전처리를 하는 과정에서 내가 원하는 방향으로 데이터 값이 바뀌니 되게 재밌었고 팀원들과 케미가 잘 맞아 정말 즐겁게 진행했습니다 꽃심조 화이팅🌸

- **이재범**:
  촉박할 줄은 알았는데, 이렇게 촉박할 줄이야... 처음 해보는 프론트 개발과 우당탕탕 디버깅... 배우면서 하느라 힘들었지만 정말 짜릿했어요...🙃
